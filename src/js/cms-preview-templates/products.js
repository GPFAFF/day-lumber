      ...
      <div className="bg-off-white pv4">
        <div className="ph3 mw7 center">
          ...
          <div className="flex-ns flex-wrap mhn2-ns mb3">
            {(entry.getIn(["blurbs"])).map((blurb, index) =>
              <div className="ph2-ns w-50-ns mb" key={index}>
                <h3>{blurb.get("heading")}</h3>
                <img src={blurb.get("image")} alt="" className="center db mb3" style={{width: "240px"}}/>
                <p>{blurb.get("text")}</p>
              </div>)}
          </div>
        </div>
